...
The `Form` accepts three arguments:

| Argument Name | Type | Required | Default | Description |
|-----------------|--------------------------------------------|----------|--------------------------------|-----------------------------------------------------------------------------------------------|
| `fields` | `IFormSchema[]` | true |  | This is the definition of each field in the form. (See the `IFormSchema` type below) |
| `initialValues` | `{ [fieldName: string]: string | number }` | false | `{}` | This is the interval at which the `callback` will be called. |
...
Here is the `IFormOptions` type with the other dependent types. See the Validation section for a 
